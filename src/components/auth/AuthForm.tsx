...
export default function AuthForm({ defaultMode = "login" as Mode }: { defaultMode?: Mode }) {
  ...
  const inputCls =
    "w-full rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-neutral-900/60 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-black/10 dark:focus:ring-white/20"
  const btnCls =
    "w-full rounded-xl bg-black text-white dark:bg-white dark:text-black px-4 py-2.5 font-medium disabled:opacity-60 disabled:cursor-not-allowed"
              ...
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-neutral-600 dark:text-neutral-300"
                  >
